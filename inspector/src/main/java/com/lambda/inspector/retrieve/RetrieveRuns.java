...
public class RetrieveRuns implements RequestHandler<TargetDTO, List<RunModel>> {

    static AmazonDynamoDB client;

    @Override
    public List<RunModel> handleRequest(TargetDTO input, Context context) {
